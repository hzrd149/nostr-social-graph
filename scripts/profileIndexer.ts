...
import { SOCIAL_GRAPH_ROOT, DATA_DIR, SOCIAL_GRAPH_LARGE_BIN, FUSE_INDEX_FILE, DATA_FILE, RELAY_URLS, PROFILE_PICTURE_URL_MAX_LENGTH, PROFILE_NAME_MAX_LENGTH } from "../src/constants";
